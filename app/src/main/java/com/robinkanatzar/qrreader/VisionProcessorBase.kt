...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    private fun processImage(
        ...
        requestDetectInImage(
            ...
            true
        ).addOnSuccessListener(executor, OnSuccessListener { processLatestImage(graphicOverlay) })
    ...
    private fun requestDetectInImage(
        ...
        return detectInImage(image).addOnSuccessListener(executor, OnSuccessListener { results ->
